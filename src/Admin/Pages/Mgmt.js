...
const Mgmt = () => {
  ...
  const dataToExcel=()=>{
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "Management"); //create new spresdsheet
    XLSX.writeFile(workbook, "Admissions_Management.xlsx", { compression: true }); //export to .xlsx
  }
