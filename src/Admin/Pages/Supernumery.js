...
const Supernumery = () => {
  ...
  const dataToExcel=()=>{
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "PIO_OCI_CIWG"); //create new spresdsheet
    XLSX.writeFile(workbook, "Admissions_Supernumery.xlsx", { compression: true }); //export to .xlsx
  }
