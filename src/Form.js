...
function Form() {
  ...
  return (
    <div className="w-screen h-auto xl:h-screen bg-gradient-to-tl from-rock-blue-300 via-rock-blue-300 to-rock-blue-400 flex justify-center">
      <div className=" xl:w-[1160px] my-[30px] xl:my-auto">
        ...
        <div className="w-full bg-white rounded-md h-auto flex flex-col xl:flex-row shadow-md mt-8">
          <div className="xl:w-1/2 h-[584px] pt-6 ">
            ...
            <div className=" flex justify-center p-5 space-x-2">
              <TextField label="Contact Ph. No(M)" type="text" size="small" required />
              <TextField label="Contact Ph. No(Kerala)" type="text" size="small" required/>
              <TextField label="DOB" type="date" size="small"  InputLabelProps={{
              shrink: true,
            }} />
            </div>
            <div className=" flex  p-5  space-x-2">
              <TextField label="Photo Upload" type="file" size="small"  InputLabelProps={{
              shrink: true,
            }} required />
            </div>
            <div className=" flex flex-col space-y-2 p-5 mt-4 ">
              <label className="text-xl ml-2">Contact Address</label>
              <TextField fullWidth label="House Name" type="text" size="small" required />
            </div>
             <div className=" flex items-center p-5 space-x-2">
              <TextField className="w-1/2" label="State" type="text" size="small" required />
              <TextField className="w-1/2" label="District" type="text" size="small" />
              
            </div>
            <div className=" flex items-center p-5 space-x-2">
              <TextField className="w-1/2" label="City" type="text" size="small" required />
              <TextField className="w-1/2" label="Pincode" type="text" size="small" />
            </div>
          </div>
          ...
          <div className=" flex flex-col space-y-2 p-5 mt-1 ">
            ...
            <div className=" flex items-center p-5 space-x-2">
              <TextField className="w-1/2" label="Parent/Gaurdian" type="text" size="small" required />
              <TextField className="w-1/2" label="Occupation" type="text" size="small" />
              
            </div>
            <div className=" flex items-center p-5 space-x-2">
              <TextField className="w-1/2" label="NRI Sponsor" type="text" size="small" required />
              <TextField className="w-1/2" label="Relation with applicant" type="text" size="small" />
